...
int main() {
    ...
    bool halfSheet = false;
    
    // Calculate number of full sheets of cake
    int fullSheets = guests / 50; // Each full sheet feeds 50 guests
    int remainingGuests = guests % 50; // Remaining guests after dividing by 50
    ...
    fullSheetCost = fullSheets * COST_PER_FULL_SHEET;
